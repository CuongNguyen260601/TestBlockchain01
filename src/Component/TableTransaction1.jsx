...
import { LayDanhSachGiaoDichGui, LayDanhSachGiaoDichNhan } from '../Function/ListFuction';
...
function TableTransaction(props) {
    ...
    const onClickLay  =()=>{ LayDanhSachGiaoDichGui(ContractBank,Account).then(res=>{
        setlistNhan(res);
    })}
  return (
    <div className = "container mt-5">
    <button type="button" class="btn btn-primary" onClick={onClickLay}>Lấy danh sách lịch sử gửi tiền</button>
      <table class="table">
        <thead>
          <tr>
