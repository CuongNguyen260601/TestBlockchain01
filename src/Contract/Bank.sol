...
contract Bank is Ownable{
    ...
    uint8 public PhanTramGiaoDich;
    
    struct BienLaiGiaoDich{
        address NguoiGui;
        address NguoiNhan;
        uint    ThoiGianGui;
        uint    SoTien;
    ...
    mapping (uint => BienLaiGiaoDich) public DanhSachTatCaGiaoDich;
    ...
    constructor(address _KhoTien,uint8 _PhanTramGiaoDich){
        KhoTien = IERC20(_KhoTien);
        TongSoGiaoDich = 0;
        PhanTramGiaoDich = _PhanTramGiaoDich;
    }
    ...
    function ThayDoiPhanTramGiaoDich(uint8 _PhanTramGiaoDich) public onlyOwner{
        require(_PhanTramGiaoDich>0,"Pham tram giao dich phai lon hon 0 !");
    ...
    function ChuyenTien(address _NguoiNhan, uint _SoTien) public{
        ...
        uint _MaBienLai = TongSoGiaoDich +1;
        
        TongSoGiaoDich +=1;
        
        uint _PhiGiaoDich = _SoTien*PhanTramGiaoDich/10000;
        
        DanhSachTatCaGiaoDich[_MaBienLai] = BienLaiGiaoDich({NguoiGui: msg.sender, NguoiNhan:_NguoiNhan,ThoiGianGui:block.timestamp,SoTien:_SoTien,PhiGiaoDich:_PhiGiaoDich});
